...
const covers = {
  ...
  shantou: `${I('汕大印象丨想在春和景明时与你相见.jpg')}`,
  jova: `${I('JovaAI 不是多一个 AI 工具，而是一套 AI 原生经营系统.png')}`,
  activity: `${I('拉布布免费送！来青云，让学习充满惊喜！.png')}`,
  heritage: `${I('看见非遗  铁枝木偶：指尖上的非遗传奇.jpeg')}`,
  editorial: `${I('不正经优雅启示录.jpg')}`,
}
...
const collections = [
  { id: 'brand', index: '04', eyebrow: 'BRAND & PRODUCT', title: <>品牌与<span>产品内容</span></>, description: '面向产业级 AI 与激光显示两类科技赛道，把专业业务逻辑、产品价值和品牌调性转译成清晰可信的公众号内容。', groups: [
    { title: '艾氪智能 · 产业 AI 内容', note: '内容策划｜品牌文案｜AI 辅助创作｜视觉协同', summary: '产业级 AI 企业，聚焦 Agentic OS、企业智能体和 AI 原生经营系统，服务制造业、供应链、外贸等 ToB 场景。我的工作是快速吃透陌生业务逻辑，将技术概念转译为企业经营价值，在专业、前沿、可信赖的官方调性下完成内容全链路生产。', skills: ['快速拆解产业 AI / 企业智能体业务逻辑', '提炼差异化产品卖点与品牌叙事', 'AI 工具协同选题、文案、配图生产', '把控科技公众号官方调性'], items: [
      ...
      { image: `${I('supplement/image3.png')}`, tag: '产业智能体内容', title: '艾氪智能，要做 ToB 世界的产业智能体电网', link: 'https://mp.weixin.qq.com/s/ANeoXYfHjgC_PHEdlYesdA' },
      { image: `${I('supplement/image5.png')}`, tag: '产业 AI 观点解读', title: '产业级 Agent 的真正门票：把千场定制熬成 ICB', link: 'https://mp.weixin.qq.com/s/JvtIaf7QDQEka1wsBJTqqA' },
    ]},
    { title: '光峰科技 · 产品案例内容', note: '产品宣传策划｜图文排版｜案例包装', summary: '科创板上市激光显示科技企业，业务覆盖工程投影、文旅演艺、展馆展厅与城市地标等专业场景。围绕产品案例与场景化内容，用更直观的表达帮助行业客户理解技术价值与落地效果。', skills: ['快速理解激光显示与工程投影专业场景', '将产品参数转化为场景体验和客户价值', '通过图文节奏与排版强化产品展示效果'], items: [
      { image: `${I('走进光影  当舞台遇见投影：那些让演出“破次元”的光影魔法.jpg')}`, tag: '场景化内容', title: '走进光影｜当舞台遇见投影：那些让演出“破次元”的光影魔法', link: 'https://mp.weixin.qq.com/s/t5WSJJUbGipuYBrItdNeY' },
      { image: `${I('supplement/image1.jpg')}`, tag: '文旅工程案例', title: '大运扬州：古运河上的夜游光影体验', link: 'https://mp.weixin.qq.com/s/RrZxa8EDnGI6dKrEN1Jrxg' },
      { image: `${I('supplement/image2.jpg')}`, tag: '文旅工程案例', title: '长征：沉浸式情景音舞史诗', link: 'https://mp.weixin.qq.com/s/g4MUSKlnTGJTW4DqDhm4Og' },
    ]},
  ]},
  { id: 'growth', index: '05', eyebrow: 'GROWTH & CONVERSION', title: <>营销与<span>转化内容</span></>, description: '从曝光到行动：以信任型内容、裂变活动和私域承接，让内容成为可追踪的业务结果。', metrics: ['课程转化 300+ 单', '私域引流近千人', '报课率提升 23%', '用户故事成交 100+ 单'], groups: [
    { title: '青云教育 · 教培转化内容', note: '公众号内容主创｜视觉物料设计｜暑期报名人数增长 40%', summary: '锚定高中生与家长的核心决策点，打造「信任型 + 裂变型 + 招聘型」多元转化内容，联动私域完成招生增长。累计转化课程报名 300+ 单，报课率提升 23%。', skills: ['拆解师资、班型、本地化服务卖点', '用热点 IP 设计低门槛裂变规则', '以年轻化语态缩短招聘转化链路'], compact: true, items: [
      { image: `${I('青云招生｜学霸养成计划之高分修炼秘籍.jpg')}`, tag: '招生转化文', title: '学霸养成计划之高分修炼秘籍', link: 'https://mp.weixin.qq.com/s/zu5xOX3QJL1JEnWBgMClbQ' },
      { image: covers.activity, tag: '裂变活动文', title: '拉布布免费送！来青云，让学习充满惊喜！', link: 'https://mp.weixin.qq.com/s/hkbSoTrVMOpMhuDbtInLUw' },
      { image: `${I('青云教育，职等你来！.png')}`, tag: '雇主品牌文', title: '青云教育，职等你来！', link: 'https://mp.weixin.qq.com/s/oLjduE_tSPrkJedrZwMLcQ' },
    ]},
    { title: '橄榄医疗 · 大健康内容运营', note: '公众号内容运营｜私域内容策划｜从 0 搭建健康科普内容矩阵', summary: '从 0 搭建健康科普、用户故事、企业服务三大内容方向，测试爆款选题并打通「内容引流—私域转化」链路。以内容与裂变组合打法，实现私域用户新增近千人，用户故事类内容带来 100+ 单成交。', skills: ['围绕企业体检痛点包装服务价值', '文末植入测评工具承接有效留资', '验证真实经历分享为爆款选题方向'], compact: true, items: [
      { image: `${I('橄榄医疗  创新企业健康管理，打造员工健康新生态.png')}`, tag: '企业服务宣传', title: '创新企业健康管理，打造员工健康新生态', link: 'https://mp.weixin.qq.com/s/pp_ycSlotS6PChfUVF9K2g' },
      { image: `${I('橄榄枝健康企业logo.jpg')}`, tag: '内容体系搭建', title: '健康科普 × 用户故事 × 企业服务内容矩阵', link: null },
    ]},
  ]},
  { id: 'stories', index: '06', eyebrow: 'ACTIVITY & STORIES', title: <>活动传播与<span>人物故事</span></>, description: '既能覆盖预热、现场、回顾的节点传播，也能深入人物与非遗现场，把真实细节组织成有温度的内容。', groups: [
    { title: '大型活动整合传播', note: '活动预热策划｜现场实时采编｜多团队协作｜图文整合呈现', items: [
      { image: `${I('解锁新身份！遇见无数可能性的未来.jpg')}`, tag: '新生入学季', title: '解锁新身份！遇见无数可能性的未来', link: 'https://mp.weixin.qq.com/s/u4suKbumPMUkfSrcKrrUSQ' },
      { image: `${I('邀你来看校运会，Passion！.jpg')}`, tag: '赛事活动', title: '邀你来看校运会，Passion！', link: 'https://mp.weixin.qq.com/s/LrGZzUr5sYLYvWfDWnh0UA' },
      { image: `${I('感恩有您，一路同行！.jpg')}`, tag: '教师节专题', title: '感恩有您，一路同行！', link: 'https://mp.weixin.qq.com/s/_pvqkXmGJpmWi18qNU1GcA?scene=1' },
      { image: `${I('这一槌，把“非遗名片”打出来了.png')}`, tag: '文化活动', title: '这一槌，把“非遗名片”打出来了', link: 'https://mp.weixin.qq.com/s/SSelDBKqQP4BBH6ds6A0Pg' },
    ]},
    { title: '人物与故事内容', note: '采访提纲设计｜故事细节挖掘｜人物形象塑造｜长文结构把控', items: [
      ...
      { image: `${I('看见非遗  潮州木雕：方家有神技，大匠无弃材.png')}`, tag: '非遗人物纪实', title: '看见非遗｜潮州木雕：方家有神技，大匠无弃材', link: 'https://mp.weixin.qq.com/s/Io4uDqY47YvKdabImabG_A' },
      { image: `${I('新生特辑  山海仍有新秋 青春没有定义.jpg')}`, tag: '青春人物故事', title: '新生特辑｜山海仍有新秋 青春没有定义', link: 'https://mp.weixin.qq.com/s/9UWs3Dm-WGWxg5K_6ToSMQ' },
      { image: `${I('creative-escape.png')}`, tag: '创意视觉专题', title: '“不正经”优雅启示录', link: 'https://mp.weixin.qq.com/s/EnCEEtvV4001lqarOrE9sw' },
    ]},
  ]},
]

const extraWorks = [
  { image: `${I('AI教母李飞飞未来十年职场只剩两类人.png')}`, type: '企业视频 · 艾氪智能', title: 'AI教母李飞飞：未来十年职场只剩两类人', link: 'https://weixin.qq.com/sph/A9LjQ0Hcpp' },
  { image: `${I('YC内部AI实操如何让AI从助手进化到大脑”.png')}`, type: '企业视频 · 艾氪智能', title: 'YC内部AI实操：如何让AI从助手进化到“大脑”', link: 'https://weixin.qq.com/sph/AYu6wXojfn' },
  { image: `${I('泰顺画中游.png')}`, type: '企业视频 · 光峰科技', title: '泰顺画中游', link: 'https://weixin.qq.com/sph/AaXPLDujGn' },
  { image: `${I('光影载道，瓷上中国.png')}`, type: '企业视频 · 光峰科技', title: '光影载道，瓷上中国', link: 'https://weixin.qq.com/sph/AO31dXTFhR' },
]

const socialWorks = [
  { title: '言叶之庭电影感', platform: '抖音短视频', image: `${I('doc-media/image1.png')}`, link: 'https://v.douyin.com/jWAJx6z6HUY/' }, { title: '高考祝福', platform: '抖音短视频', image: `${I('doc-media/image2.png')}`, link: 'https://v.douyin.com/uyjXVesK2SA/' }, { title: '鱼跃龙门', platform: '抖音短视频', image: `${I('doc-media/image3.png')}`, link: 'https://v.douyin.com/h1_RTm7P25c/' }, { title: '毕业季转场', platform: '抖音短视频', image: `${I('doc-media/image4.png')}`, link: 'https://v.douyin.com/YnF79YQpIws/' }, { title: '希区柯克式变焦', platform: '抖音短视频', image: `${I('doc-media/image5.png')}`, link: 'https://v.douyin.com/n4QcwmjWZw4/' }, { title: '校园与世纪晚霞', platform: '抖音短视频', image: `${I('doc-media/image6.png')}`, link: 'https://v.douyin.com/NDHXjEH3AUc/' }, { title: '校园热点内容', platform: '官方微博', image: `${I('doc-media/image7.png')}`, link: 'https://weibo.com/2413579830/5025205091041562' }, { title: '校园日常内容', platform: '官方微博', image: `${I('doc-media/image8.png')}`, link: 'https://weibo.com/2413579830/5023025225270494' }, { title: '校园专题内容', platform: '官方微博', image: `${I('doc-media/image9.png')}`, link: 'https://weibo.com/2413579830/4837502789094550' },
]

const experiences = [
  { date: '2022.10 — 至今', logo: `${I('shantou-university-logo.png')}`, name: '汕头大学党委宣传统战部', role: '官方公众号 · 校报中心', result: '统筹 40 人校园内容团队，覆盖公众号、校报与活动传播；累计内容阅读 40 万+、粉丝净增 6 万+。', skills: ['内容全案统筹', '大型活动传播', '采编与审核'] },
  { date: '2023.06 — 2023.09', logo: `${I('青云教育企业logo.jpg')}`, name: '青云教育', role: '教培内容营销', result: '围绕招生、裂变与招聘三类场景打造转化内容，累计课程转化 300+ 单，报课率提升 23%。', skills: ['转化型文案', '私域引流', '营销节点'] },
  { date: '2024.06 — 2024.08', logo: `${I('橄榄枝健康企业logo.jpg')}`, name: '深圳橄榄枝健康', role: '大健康内容运营', result: '从 0 搭建健康科普、用户故事、企业服务内容矩阵，组合打法新增私域用户近千人。', skills: ['内容体系搭建', '用户洞察', '数据复盘'] },
  { date: '2025.06 — 2025.09', logo: `${I('光峰科技企业logo.jpg')}`, name: '深圳光峰科技股份有限公司', role: '产品案例内容', result: '拆解激光显示与文旅工程场景，用产品案例包装和图文排版强化专业内容的传播力。', skills: ['复杂产品转译', '案例包装', '视觉排版'] },
  { date: '2026.06 — 2026.07', logo: `${I('艾氪智能企业logo.jpg')}`, name: '深圳艾氪未来人工智能', role: '产业 AI 品牌内容', result: '完成产业 AI 品牌节点与产品解读内容，将技术概念转化为企业经营价值和品牌表达。', skills: ['B端品牌文案', '科技内容策划', 'AI 协同创作'] },
]
  ...
  return <>
    ...
    <main>
      <section className="hero" id="home">
        <video className="hero-video" autoPlay muted loop playsInline preload="metadata" poster={covers.shantou}><source src={`${import.meta.env.BASE_URL}video/hero-bg.mp4`} type="video/mp4" /></video>
      ...
      <section className="intro shell" id="about" data-animate-section>
        ...
        <div className="intro-grid">
          <div className="portrait-wrap"><img src={`${I('马菀虹个人照片.jpg')}`} alt="马菀虹" /><div className="portrait-label">MA WANHONG<br /><small>CONTENT OPERATOR</small></div></div>
      ...
      <section className="other-work shell" id="other"><div className="section-top"><p className="eyebrow"><span /> 07 / OTHER WORKS</p><h2 className="section-title">视频与<span>多平台内容</span></h2></div><p className="section-lede">公众号之外，我也参与视频内容策划、脚本文案与官方社媒内容协同，让品牌表达跨渠道保持同一种语言。</p><div className="video-grid">{extraWorks.map(work => <Story key={work.title} image={work.image} type={work.type} title={work.title} link={work.link} />)}</div><div className="platform-block"><div className="platform-copy"><p className="eyebrow"><span /> DOUYIN</p><h3>官方抖音内容策划</h3><p>参与学校官方抖音账号内容策划与发布，负责脚本策划、文案配合拍摄执行；独立制作发布视频 30+ 条，结合热点做校园内容二次创作。</p></div><div className="social-cover-grid">{socialWorks.slice(0,6).map((work, index) => <SocialCard key={work.title} work={work} index={index} />)}</div></div><div className="platform-block"><div className="platform-copy"><p className="eyebrow"><span /> WEIBO</p><h3>官方微博日常运营</h3><p>参与官方微博图文发布与话题配合，围绕校园热点提升内容吸引力；博文平均阅读量 3w+，平均点赞量位列部门 Top 1。</p></div><div className="social-cover-grid social-cover-grid-three">{socialWorks.slice(6).map((work, index) => <SocialCard key={work.title} work={work} index={index} />)}</div></div><div className="platform-block paper-block"><div className="platform-copy"><p className="eyebrow"><span /> CAMPUS PAPER</p><h3>校报文章与深度专题</h3><p>担任校报主编，负责深度采访、稿件采写、文字终审及版面排版；以信息分层和读者动线组织官方内容。</p></div><div className="paper-strip"><img src={`${I('校报1.jpg')}`} alt="校报作品" loading="lazy" /><img src={`${I('校报2.jpg')}`} alt="校报作品" loading="lazy" /></div></div><div className="platform-block nandu-block"><div className="platform-copy"><p className="eyebrow"><span /> VIDEO PROJECT</p><h3>南方都市报视频实验室</h3><p>完整参与从选题、脚本、分镜到拍摄、剪辑、调色与输出的全流程，形成以叙事为核心、技术服务于表达的视频创作能力。作品获 2.4 万播放、近 1 千赞。</p></div><a className="nandu-work" href="https://n.oeeee.com/video/NVaJYiD2JYZN?from=timeline&layer=2&date" target="_blank" rel="noreferrer"><img src={`${I('南方都市报视频实验室结课作品.png')}`} alt="南方都市报视频实验室作品" loading="lazy" /><span>查看南方都市报视频作品 <ArrowUpRight size={15} /></span></a></div></section>

      <section className="contact" id="contact"><DeferredVideo /><div className="contact-shade" /><div className="contact-fluid" aria-hidden="true"><i /><i /><i /></div><div className="contact-texture" /><div className="contact-orbit orbit-one" /><div className="contact-orbit orbit-two" /><div className="shell contact-inner"><p className="eyebrow light"><span /> 08 / CONTACT</p><div className="contact-main"><div className="contact-title"><p>CONTENT · STRATEGY · GROWTH</p><h2>下一段值得<br />被<span>看见</span>的故事，<br />期待与你一起完成。</h2></div><div className="contact-card"><p className="contact-card-label">OPEN TO CONTENT OPERATION ROLES</p><p>我相信好的内容同时关照品牌、用户与业务目标。期待加入有长期主义的团队，用清晰、有温度的内容解决真实问题。</p><a className="email-link" href="tel:15815150264"><span>158 1515 0264</span><ArrowUpRight /></a><div className="contact-meta"><span>马菀虹</span><span>微信同号</span><span>公众号运营</span></div></div></div><div className="contact-bottom"><p>MA WANHONG · CONTENT PORTFOLIO · 2026</p><a href="#home">BACK TO TOP <ArrowUp size={14} /></a></div></div></section>
    </main>
  </>
}
...
function DeferredVideo() {
  ...
  useEffect(() => { if (shouldLoad) ref.current?.load() }, [shouldLoad])
  return <video ref={ref} className="contact-video" autoPlay muted loop playsInline preload="none">{shouldLoad && <source src={`${import.meta.env.BASE_URL}video/contact-bg.mp4`} type="video/mp4" />}</video>
}
